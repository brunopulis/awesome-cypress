...
- [Qualflare](https://github.com/Qualflare/qualflare-cypress) - Uploads results for history-based flaky-test detection, failure clustering, and release-risk scoring.
